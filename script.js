...
function Hide() {
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const hiddenSection = document.querySelector(".hidden-on-mobile");
...
function ProjectHide() {
    ...
    const hiddenProjects = document.querySelectorAll('.hide-before-449');
    ...
    document.addEventListener("DOMContentLoaded", () => {
    const projectToggleBtn = document.getElementById("toggleProjectBtn");
    const projects = document.querySelectorAll("#project-cont .hide-before-449");
    const projectIcon = projectToggleBtn.querySelector("i");

    projectToggleBtn.addEventListener("click", () => {
        projects.forEach(project => project.classList.toggle("show-project"));
        projectIcon.classList.toggle("fa-chevron-down");
        projectIcon.classList.toggle("fa-chevron-up");
    });
});
}
ProjectHide()
